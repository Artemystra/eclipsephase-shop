...
export default class EPshopSheet extends HandlebarsApplicationMixin(ActorSheetV2) {
  ...
  static PARTS = {
    body: {
      template: "modules/eclipsephase-shop/templates/shop-sheet.html",
      root: true,
  ...
  _getSheetTemplate() {
    ...
    if (game.user.isGM || actor.isOwner) {
      return "modules/eclipsephase-shop/templates/shop-sheet.html";
    }
    return "modules/eclipsephase-shop/templates/shop-sheet-limited.html";
  }
